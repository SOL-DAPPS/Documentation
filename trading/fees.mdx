...
| **Custom** | You decide | Full control over priority fee. Set your own value via `customValue` |
...
<ParamField body="priorityFee.customValue" type="number | null" default="null">
  Set a custom priority fee in SOL. When set, overrides the mode value.
...
<Tabs>
  ...
  <Tab title="Custom">
    ...
    <Note>
    When `customValue` is set, it overrides the mode. Minimum recommended: 0.0002 SOL.
    </Note>
  </Tab>
</Tabs>
